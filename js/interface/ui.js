...
info.addEventListener("click", e => {
  ...
  modalControls.textContent =
    "Use Arrow Keys to move. Press C to change character.";
  let modalInstructions = document.createElement("p");
  modalInstructions.classList.add("modal-text");
  modalInstructions.textContent =
    "Your goal is to navigate across the grid to the water on top while avoiding deadly ladybugs.";
